...
public class MessageHandler {
    ...
    private SendMessage handleGearChatMode(String chatId) {
        ...
        SendMessage msg = new SendMessage(chatId,
                """
                        � **Генератор Фото-Шпаргалок**

                        Напишіть, що ви плануєте знімати.
                        Я створю для вас **персональну інструкцію** з налаштуваннями камери (ISO, витримка, діафрагма) та вибором об'єктива.
                        """);
        msg.setReplyMarkup(KeyboardFactory.exitKeyboard());
        return msg;
    }
